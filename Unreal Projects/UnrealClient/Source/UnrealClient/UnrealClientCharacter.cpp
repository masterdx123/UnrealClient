...
void AUnrealClientCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AUnrealClientCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AUnrealClientCharacter::GetHasRifle()
{
	return bHasRifle;
}